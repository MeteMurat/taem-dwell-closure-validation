# -*- coding: utf-8 -*-
"""single_mis1_main_v8_1_eventfix.py

Run the success-first V8.1 event-fix recovery path.
...
def main():
    ...
    parser.add_argument("--out", default=os.path.join("store", "data_saved", "mis1_state_first_v8_1_eventfix.csv"))
