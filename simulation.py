...
class TrajectorySimulation:
    ...
    def save_data(self) -> None:
        ...
        # Critical for online trajectory simulation hooks:
        # - Energy-like variable E is consumed by guidance-online interpolation
        # - Additional guide variables are optionally logged via GUIDE_SAVE_PARAM
        self.db_save_dict["E"] = self.mis.guide.get("E", None)

        for k in getattr(glbs, "GUIDE_SAVE_PARAM", []):
            self.db_save_dict[k] = self.mis.guide.get(k, None)
