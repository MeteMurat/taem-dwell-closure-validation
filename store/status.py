...
class MissileStatus:
    ...
    # --- dict-like compatibility helpers ---
    # Some parts of the codebase treat `status` as a mapping, e.g. status["height"] = 0.
    # Provide minimal mapping semantics while keeping the canonical attribute interface.
