# -*- coding: utf-8 -*-
"""
Phase 2 / B3A heading-spread sensitivity multiset.
...
B3A_HEADING_SPREAD_DEG = float(os.environ.get("B3A_HEADING_SPREAD_DEG", "2.0"))
...
STORE_DATA = os.environ.get("B3A_STORE_DATA", os.path.join("store", "data_saved", "phase2_B3A_heading_spread_combined.csv"))
