...
$BackupDir = Join-Path $FigDir "BACKUP_BEFORE_FINAL_CLEAN_SOURCE_REBUILD_$Stamp"
...
Write-Host "`n[1] Backing up current figures..." -ForegroundColor Cyan
...
# ============================================================
# Figure 2: use real source make_fig01_b5d_success_rates.py
# ============================================================

Write-Host "`n[2] Rebuilding Figure 2 from real source..." -ForegroundColor Cyan

python ".\make_fig01_b5d_success_rates.py"

Copy-Item -LiteralPath ".\fig01_phase2_success_rates_professional.pdf" -Destination (Join-Path $FigDir "fig01_phase2_success_rates_professional.pdf") -Force
if (Test-Path ".\fig01_phase2_success_rates_professional.png") {
    Copy-Item -LiteralPath ".\fig01_phase2_success_rates_professional.png" -Destination (Join-Path $FigDir "fig01_phase2_success_rates_professional.png") -Force
}

# ============================================================
# Figure 3 and Figure 5: clean source-based rebuild
# Figure 4: clean log-scale rebuild from B5E data
# ============================================================

$Py = ".\make_figures_3_4_5_final_clean.py"
...
Write-Host "`n[3] Rebuilding Figures 3, 4, and 5..." -ForegroundColor Cyan
python $Py

Write-Host "`n[4] Opening final clean figures..." -ForegroundColor Cyan
...
Write-Host "`n[DONE] Rebuilt final clean manuscript figures." -ForegroundColor Green
